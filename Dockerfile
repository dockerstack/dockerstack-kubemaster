...
tar -xvf flannel-0.5.2-linux-amd64.tar.gz && tar -xvf kubernetes.tar.gz && tar -xvf tar -xvf kubernetes/server/kubernetes-server-linux-amd64.tar.gz  &&\
cp -rf flannel-0.5.2/flanneld /usr/bin/  &&\
